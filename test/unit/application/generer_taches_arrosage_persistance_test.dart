...
void main() {
  ...
  setUp(() async {
    ...
    fiches = _MockFiches();
    // Defaults: notifications allowed, and no catalogue sheet resolves (the
    // task then falls back to its generic title — irrelevant to these
