# ADR-0020 — Regroupement des tâches par geste (agrégation d'affichage, notification unique par jour)

- **Statut** : **Accepté** — livré (2026-07-27), mergé le 2026-08-16
- **Date** : 2026-07-27
- **Numérotation** : rédigé comme « ADR-0019 » sur sa branche, renuméroté
  **0020** au merge — le numéro 0019 avait été pris entre-temps par le
  [report du post-récolte](0019-report-post-recolte-v11.md), mergé le 2026-07-17.
  Les commits d'origine (`516cad9`, `e0eea76`) citent donc l'ancien numéro.
